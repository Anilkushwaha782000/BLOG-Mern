...
function About() {
  return (
    <div className="max-w-6xl mx-auto p-6   bg-white dark:border-gray-700 dark:bg-gray-800 shadow-md border border-teal-500 rounded-tl-3xl rounded-br-3xl mt-10 mb-10">
      <h1 className="text-4xl font-bold mb-4 text-center  text-gray-900 dark:text-white">About Me</h1>
      <p className="text-lg  text-center  text-gray-900 dark:text-white"> Welcome to my blog! Here, I share my journey and insights as a full-stack developer.</p>
      <div className="mt-10 flex flex-col md:flex-row items-center">
        ...
        <div className="text-left">
          <h2 className="text-2xl font-bold mb-2  text-gray-900 dark:text-white">Anil Kushwaha</h2>
